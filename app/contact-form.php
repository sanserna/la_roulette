...
<table rules="none" style="min-width: 400px; max-width: 700px; border-collapse: collapse; padding: 0px;">
    <tr style="padding: 0px;">
        <td style="padding-right: 5px; padding-top: 20px; width: 10px;" valign="top"><h3 style="color: #ED1C24; padding: 0px; padding-top: 10px; margin: 0px;"><strong>Nombre:</strong></h3></td>
    </tr>
    <tr style="padding: 0px;">
      <td style="padding-right: 5px; padding-top: 5px; width: 100px;" valign="top">'.$nombre.'</td>
    </tr>
    <tr style="padding: 0px;">
        <td style="padding-right: 5px; padding-top: 20px; width: 10px;" valign="top"><h3 style="color: #ED1C24; padding: 0px; padding-top: 10px; margin: 0px;"><strong>Email:</strong></h3></td>
    </tr>
    <tr style="padding: 0px;">
...
<br />
<br />
<p style="padding: 0px; margin: 0px;">Enviado desde www.laroulette.com.co</strong></p>
';
// definir cabeceras
